...
<div class="container py-5">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row">
                <?php $__currentLoopData = ['member1.png', 'member2.jpg', 'member3.jpg']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4 text-center mb-4">
                        <div class="card shadow-sm" style="padding-top: 20px;">
                            <img src="<?php echo e(asset('images/' . $member)); ?>" alt="Team Member" class="card-img-top rounded-circle mb-3" style="width: 150px; height: 150px; display: block; margin: 0 auto;">
                            <div class="card-body">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\cynti\ecohaul\resources\views/about.blade.php ENDPATH**/ ?>